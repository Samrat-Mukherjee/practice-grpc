...
type CoffeeShopClient interface {
	...
	PlaceOrder(ctx context.Context, in *Order, opts ...grpc.CallOption) (*Recept, error)
	GetOrderStatus(ctx context.Context, in *Recept, opts ...grpc.CallOption) (*OrderStatus, error)
}
...
func (c *coffeeShopClient) PlaceOrder(ctx context.Context, in *Order, opts ...grpc.CallOption) (*Recept, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Recept)
...
func (c *coffeeShopClient) GetOrderStatus(ctx context.Context, in *Recept, opts ...grpc.CallOption) (*OrderStatus, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OrderStatus)
...
type CoffeeShopServer interface {
	...
	PlaceOrder(context.Context, *Order) (*Recept, error)
	GetOrderStatus(context.Context, *Recept) (*OrderStatus, error)
...
func (UnimplementedCoffeeShopServer) PlaceOrder(context.Context, *Order) (*Recept, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PlaceOrder not implemented")
}
func (UnimplementedCoffeeShopServer) GetOrderStatus(context.Context, *Recept) (*OrderStatus, error) {
...
func _CoffeeShop_GetOrderStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoffeeShopServer).GetOrderStatus(ctx, req.(*Recept))
	}
	return interceptor(ctx, in, info, handler)
}
